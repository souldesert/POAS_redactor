package gui.redactor.addNewLine;
...
//        if(metkaField.getText() == null || metkaField.getText().length() == 0) {
//            errorMessage += "Не заполнено поле 'Метка'!\n";
//        }
//
//        if(uslovieField.getText() == null || uslovieField.getText().length() == 0) {
//            errorMessage += "Не заполнено поле 'Условие'!\n";
//        }
//
//        if(linopField.getText() == null || linopField.getText().length() == 0) {
//            errorMessage += "Не заполнено поле 'Линейные операторы'!\n";
//        }
//
//        if(metkaPerehodaField.getText() == null || metkaPerehodaField.getText().length() == 0) {
//            errorMessage += "Не заполнено поле 'Метка перехода'!\n";
//        }
